...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (suggest hackernews show-paren-mode lush-theme sml-mode speed-type org-tree-slide highlight-indent-guides molokai-theme monokai-theme helm-ag org-present minimal-theme paper-theme swiper-helm ediprolog gruvbox-theme noctilux-theme smart-mode-line indent-guide company-statistics ag ample-theme rainbow-mode afternoon-theme bubbleberry-theme expand-region paradox writegood-mode window-numbering websocket web-mode web-beautify use-package tango-plus-theme swiper subatomic-theme sr-speedbar sphinx-doc smartparens smart-comment rich-minority request rainbow-delimiters python-mode pydoc pony-mode parenface paren-face ox-pandoc org-pandoc org-mac-link org-download org-bullets org-beautify-theme nzenburn-theme nose-mode nginx-mode neotree markdown-mode magit leuven-theme know-your-http-well key-chord json-mode jedi irony-eldoc impatient-mode ido-vertical-mode highlight-sexp highlight-current-line helm-projectile fullscreen-mode flycheck flx-ido faceup exec-path-from-shell esup eshell-git-prompt emmet-mode elpy dracula-theme discover-my-major dired-details dictionary deft define-word darkroom company-web company-quickhelp company-jedi company-irony clojure-mode-extra-font-locking clj-refactor buffer-move bash-completion autopair aggressive-indent ace-window)))
 '(pallet-mode t)
