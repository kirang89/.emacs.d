...
;; ---------------------------
;;
;; Github-clone: A light color theme
;;
;; based on McCarthy theme @
;; https://github.com/owainlewis/emacs-color-themes/blob/master/themes/githubclone-theme.el
;; ----------------------------

(unless (>= emacs-major-version 24)
  (error "requires Emacs 24 or later."))

(deftheme githubclone "A dark color theme for Emacs")

(let ((*background*         "#FFFFFF")
      (*comments*           "#BCB5AD")
      (*constant*           "#000000")
      (*current-line*       "yellow3")
